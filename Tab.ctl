...
'this is it... the heart of the tab drawing.
    ...
    Overlay.Move 0, 0, UserControl.Width, UserControl.Height
    Overlay.ZOrder 0
    ...
    For Ix = 1 To i1.UBound Step 1
        ...
        With l1(Ix)
            ...
            If dy = 0 Then i2(Ix).ZOrder 1
            .ZOrder 0
            DT = DT + J + TabSpacing
        End With
        
        i3(Ix).Move DT - TabSpacing, dy, 30, TabHeight + 15
        If dy = 0 Then i3(Ix).ZOrder 1
